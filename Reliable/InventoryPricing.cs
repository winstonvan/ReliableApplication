...
namespace Reliable
{
    public partial class InventoryPricing : Form
    {
        ...
        private void queryButton_Click(object sender, EventArgs e)
        {
            ...
            inventoryPricingDGV.Columns[7].Width = 180;

            inventoryPricingDGV.Columns[9].Width = 70;

            inventoryPricingDGV.Columns[7].DefaultCellStyle.Format = @"#.00\%";
            ...
            inventoryPricingDGV.Columns[9].DefaultCellStyle.Format = "C";
            ...
            inventoryPricingDGV.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;

            inventoryPricingDGV.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            inventoryPricingDGV.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
        ...
        private string QueryBuilder()
        {
            ...
            query = "SELECT ItemCode AS Item_Number, ItemDescription  AS Description, SupplierName AS Vendor, SupplierPartNum AS Vendor_Part_Number, PriceUnit AS Unit_Measure, StdUnitCost AS Standard_Cost, LastPOCost AS Last_PO_Cost, PubCostPct AS Published_Cost_Percentage, PubUnitCost AS Published_Cost, ListPrice As List_Price ";
            ...
            try
            {
                ...
                for (int i = -1; i < inventoryPricingDGV.Rows.Count - 1; i++)
                {
                    for (int j = 0; j < inventoryPricingDGV.Columns.Count; j++)
                    {
                        ...
                        {
                            worksheet.Cells[cellRowIndex, cellColumnIndex] = Convert.ToDouble(inventoryPricingDGV.Rows[i].Cells[j].Value).ToString(@"#.00\%");
        ...
        private void InventoryPricing_Load(object sender, EventArgs e)
        {
